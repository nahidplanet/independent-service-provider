...
const Blog = () => {
    return (
        <div className='payment mt-3 lg:mt-5'>
            <div className="blog-one w-10/12 h-[400x]  border-4 border-yellow-600  rounded-3xl">
                <div className='one'>
                    ...
                    <div className="answer flex  ml-10">
                    ...
                    <div className="answer flex  ml-10 my-5">
                        <div className='w-6 h-6 mr-2 text-white'><span ><ChatIcon></ChatIcon></span></div>
