...
const Service = ({ service }) => {
    ...
    return (
        <div className='service w-[350px] pb-5 border  mx-auto mb-10 sm:mb-0 rounded-md hover:border-yellow-400 hover:border-2 cursor-cell '  data-aos="fade-left">
            ...
            <div className='flex justify-between px-3 text-sm'>
                ...
                <div data-aos="fade-up" className='hover:text-yellow-500'>
